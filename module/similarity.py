...
from module.sematch.semantic.sparql import EntityFeatures, StatSPARQL
from module.sematch.semantic.graph import GraphIC
from module.sematch.utility import FileIO, memoized
